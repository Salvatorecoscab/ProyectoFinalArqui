...
HD_PWD='C:/Users/Salvadorcoscab/Documents/vhdlPracticas/project_2/project_2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log LIB_LCD_INTESC_REVD.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source LIB_LCD_INTESC_REVD.tcl
