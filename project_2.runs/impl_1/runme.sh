...
HD_PWD='C:/Users/Salvadorcoscab/Documents/vhdlPracticas/project_2/project_2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log LIB_LCD_INTESC_REVD.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source LIB_LCD_INTESC_REVD.tcl -notrace
